...
namespace tl
{
    ...
    {
    public:
        data_provider_sample(std::vector<const_timeline_item_ptr> const& data);
        data_provider_sample(std::vector<const_timeline_item_ptr>&& data);
    ...
    private:
        std::vector<const_timeline_item_ptr> _data;
    };
